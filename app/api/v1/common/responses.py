...
def success_response(
    ...
    **kwargs,
    ...
    return create_response(
        data=data, message=message, status_code=status_code, success=True, **kwargs
    )
...
def created_response(
    data: Any, message: str = "Resource created successfully", **kwargs
) -> JSONResponse:
    """
...
def validation_error_response(
    message: str = "Validation failed", errors: Optional[list] = None
) -> JSONResponse:
    """
...
def forbidden_response(
    message: str = "Access forbidden", required_permission: Optional[str] = None
) -> JSONResponse:
    """
...
def conflict_response(
    message: str = "Resource conflict", conflict_type: Optional[str] = None
) -> JSONResponse:
    """
