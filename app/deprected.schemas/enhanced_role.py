...
# === Enhanced Role System Schemas ===


class EnhancedRoleCreate(BaseSchema):
    """Schema for creating enhanced role."""
...
class EnhancedRoleUpdate(BaseSchema):
    """Schema for updating enhanced role."""
...
class UserRoleAssignmentCreate(BaseSchema):
...
class UserRoleAssignmentUpdate(BaseSchema):
    ...
    context_type: Optional[str] = Field(None, description="Context type")
    context_id: Optional[int] = Field(None, description="Context ID")
    is_active: Optional[bool] = Field(None, description="Is assignment active")


class RoleFilter(BaseSchema):
    """Schema for filtering roles."""

    scope: Optional[RoleScope] = Field(None, description="Role scope")
    is_active: Optional[bool] = Field(None, description="Is role active")
    name_contains: Optional[str] = Field(None, description="Name contains")


class AssignmentFilter(BaseSchema):
    """Schema for filtering role assignments."""
