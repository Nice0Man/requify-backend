...
class TestSyntheticDataGeneration:
    ...
    def test_project_factory_creates_valid_data(self):
        ...
        for project in projects:
            ...
            assert project['status'] in ['planning', 'active', 'on_hold', 'completed', 'archived']
    ...
    def test_requirement_factory_creates_valid_data(self):
        ...
        for req in requirements:
            ...
            assert req['type'] in ['functional', 'non_functional', 'technical', 'business']
            assert req['priority'] in ['low', 'medium', 'high', 'critical']
            assert req['status'] in ['draft', 'review', 'approved', 'implemented', 'tested']
